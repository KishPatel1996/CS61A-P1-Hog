...
def swap_strategy(score, opponent_score, margin=8, num_rolls=5):
    ...
    bacon_res= abs(opponent_score%10 - opponent_score//10)+1
    if 2 * (score+bacon_res)== opponent_score:
      return 0
    elif (score+ bacon_res) == 2 * opponent_score:
      return num_rolls
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    while i<=10:
      if score>=100-i and bacon_res>=i and score+bacon_res != 2 * opponent_score:
        return 0
      i+=1

  # swine swap is nearly always helpful
    if 2 * (score+bacon_res )== opponent_score and opponent_score-(score+bacon_res)>=5:
      return 0

  # checks dice sides
    if (score + bacon_res + opponent_score) % 7 == 0:
      dice = 4
    else:
      dice = 6
    ...
    if dice==4:
      ...
      if diff_in_score< -25:
        ...
        return 4
      elif (score+bacon_res +opponent_score)%7==0:
        return 0
      ...
      if score>=97:
        ...
        return 5
      elif diff_in_score>=0 and (bacon_res +opponent_score)%7==0:
        return 0
      elif diff_in_score>=-10:
          return 5
      elif diff_in_score>=-15:
